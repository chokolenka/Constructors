...
public class Invoice {
    ...
    public static class WarehouseAccountingProgram {
        ...
        public static void inputSuppliers(ArrayList<Invoice> invoiceList) {
            ...
            suppliers.stream()
                    .filter(suppliers1 -> suppliers1  =="Savushkin")
                    .forEach(suppliers1 -> System.out.println(suppliers.toString()));
            ...
            allGoods.stream()
                    .filter(allGoods1 -> allGoods1  =="Cheese")
                    .forEach(allGoods1 -> System.out.println(allGoods.toString()));
